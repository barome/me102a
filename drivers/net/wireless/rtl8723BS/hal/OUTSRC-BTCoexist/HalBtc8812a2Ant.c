...
u4Byte	GLCoexVerDate8812a2Ant=20130912;
u4Byte	GLCoexVer8812a2Ant=0x33;
		...
		if(pBtLinkInfo->bScoExist)
		{
			...
			else if(pBtLinkInfo->bPanExist)
			{
				...
				else
				{
					...
					algorithm = BT_8812A_2ANT_COEX_ALGO_SCO_PAN;
				}
			}
		}
		else
	...
	)
{
	switch(type)
	{
		...
		case 3:
			...
			break;
		case 4:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0xdfffdfff, 0x5ffb5ffb, 0xffffff, 0x3);
			break;
	...
	else
	{
		...
		switch(type)
		{
			...
			case 1: //ANT2BT, 0x778=3
				...
				delay_ms(5);
				halbtc8812a2ant_AntennaSwitch(pBtCoexist, BTC_8812A_1ANT_SWITCH_TO_BT);
				break;
			default:
