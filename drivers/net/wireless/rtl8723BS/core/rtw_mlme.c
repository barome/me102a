...
_func_enter_;	
...
#if 1
	DBG_871X("%s 0x100: 0x%08x\n", __func__, rtw_read32(adapter, 0x100));
	DBG_871X("%s 0x520: 0x%08x\n", __func__, rtw_read32(adapter, 0x520));
	DBG_871X("%s 0x200: 0x%08x\n", __func__, rtw_read32(adapter, 0x200));
	DBG_871X("%s 0x204: 0x%08x\n", __func__, rtw_read32(adapter, 0x204));
	DBG_871X("%s 0x210: 0x%08x\n", __func__, rtw_read32(adapter, 0x210));
	DBG_871X("%s 0x280: 0x%08x\n", __func__, rtw_read32(adapter, 0x280));
	DBG_871X("%s 0x284: 0x%08x\n", __func__, rtw_read32(adapter, 0x284));
	DBG_871X("%s 0x288: 0x%08x\n", __func__, rtw_read32(adapter, 0x288));
	rtw_write32(adapter, 0x8c, 0x40000800);
	DBG_871X("%s 0x2f0: 0x%08x\n", __func__, rtw_read32(adapter, 0x2f0));
	DBG_871X("%s 0x2f4: 0x%08x\n", __func__, rtw_read32(adapter, 0x2f4));
	DBG_871X("%s 0x2f8: 0x%08x\n", __func__, rtw_read32(adapter, 0x2f8));
	DBG_871X("%s 0x2fc: 0x%08x\n", __func__, rtw_read32(adapter, 0x2fc));
#endif
	...
	if(check_fwstate(pmlmepriv, WIFI_STATION_STATE) )
	{
		...
		/* Update last_scan_time to do full scan at near future */
