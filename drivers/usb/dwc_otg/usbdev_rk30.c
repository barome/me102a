...
#define RK3066B_HOST_DRV_VBUS INVALID_GPIO

//<asus-zx20130729->do not use it #define RK3066B_OTG_DRV_VBUS  RK30_PIN3_PD5
#define RK3066B_OTG_DRV_VBUS INVALID_GPIO//<asus-zx20130729+>
