...
void ConvertBat1(MeasDataInternalType *obj)
{
  ...
  tmp32 = tmp32 - obj->info->ggbParameter->adc2_offset;
  tmp32 = tmp32*CALIBRATION_FACTOR_CONST/obj->info->ggbParameter->adc2_gain;
...
void ConvertCurrent(MeasDataInternalType *obj)
{
  ...
  tmp32 = tmp32/obj->info->ggbParameter->rSense;
  ...
  tmp32 = tmp32 - obj->info->ggbParameter->adc1_pos_offset;
  if(tmp32 > 0)
  {
    tmp32 = tmp32*CALIBRATION_FACTOR_CONST/obj->info->ggbParameter->adc1_pgain;
  }
  else
  {
    tmp32 = tmp32*CALIBRATION_FACTOR_CONST/obj->info->ggbParameter->adc1_ngain;
  }
...
void ConvertIntTemperature(MeasDataInternalType *obj)
{
  ...
  /// [AT-PM] : Apply calibration factor ; 01/25/2013
  tmp32 = tmp32 - obj->info->ggbParameter->adc_d5;
...
void ConvertExtTemperature(MeasDataInternalType *obj)
{
  ...
  while(idx < ET_NUMS)
  {
    if(obj->info->codeExtTemperature >= obj->info->ggbParameter->rtTable[idx])
    {
      break;
    }
    idx = idx + 1;
  ...
  else
  {
    ...
    tmp32 = tmp32 - obj->info->ggbParameter->rtTable[idx];
    tmp32 = tmp32*(ExtTemperatureTable[idx - 1] - ExtTemperatureTable[idx]);
    tmp32 = tmp32/(obj->info->ggbParameter->rtTable[idx - 1] - obj->info->ggbParameter->rtTable[idx]);
  ...
  /// [AT-PM] : Apply calibration factor ; 01/25/2013
  tmp32 = tmp32 - obj->info->ggbParameter->adc_d4;
...
void ConvertCharge(MeasDataInternalType *obj)
{
  ...
  UG31_LOGI("[%s]: ((%d - %d) x %d / %d + %d) / %d = %d\n", __func__,
            ...
            ADC1_IDEAL_CODE_DELTA, ADC1_VOLTAGE_100MV, obj->info->ggbParameter->rSense, tmp32);
  /// [AT-PM] : Apply board factor ; 01/25/2013
  tmp32 = tmp32 - BOARD_FACTOR_CURR_OFFSET;
  tmp32 = tmp32*BOARD_FACTOR_CONST/BOARD_FACTOR_CURR_GAIN;
  ...
  UG31_LOGI("[%s]: Calibration Factor (%d|%d/%d) -> %d\n", __func__,
            obj->info->ggbParameter->adc1_pgain, obj->info->ggbParameter->adc1_ngain, 
            obj->info->ggbParameter->adc1_pos_offset, tmp32);
...
MEAS_RTN_CODE UpiMeasurement(MeasDataType *data)
{
  ...
  data->codeExtTemperature = obj->codeExtTemperature;
  UG31_LOGI("[%s]: External Temperature Code = %d\n", __func__, data->codeExtTemperature);
  ...
  standbyUpper = (_meas_s16_)obj->info->ggbParameter->standbyCurrent;
