		...
		unsigned char reg_addr, unsigned char *data)
{
	...
	INV_I2C_INC_ACCELWRITE(3);
	INV_I2C_INC_ACCELREAD(1);
...
static int bma250_input_init(struct bma250_data *bma250)
{
	...
	printk(KERN_ERR "############# enter bma250_input_init function....................\n");
		...
		const struct i2c_device_id *id)
{
	...
	printk(KERN_ERR "############# enter bma250_probe function....................\n");
...
{
	printk(KERN_ERR "############# enter bma250_init function....................\n");
