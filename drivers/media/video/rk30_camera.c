...
{
unsigned int ipp_mem_size = PMEM_CAMIPP_NECESSARY;

	//ipp_mem_size must align to 1M
	switch(ipp_mem_size)
	{
		case 0x400000: // 30M
			ipp_mem_size = 0x500000; // 
			break;
		case 0x600000: //2//200M
			ipp_mem_size = 0x300000; // 1600x1200x1.5x6
			break;
		case 0x800000: //500 M
			ipp_mem_size = 0x800000;
			break;
		default:
			ipp_mem_size = 0x800000;
	}
        ...
        rk_camera_platform_data.meminfo.start = board_mem_reserve_add("camera_ipp_mem",ipp_mem_size);
        rk_camera_platform_data.meminfo.size= ipp_mem_size;
        ...
        rk_camera_platform_data.meminfo.start = board_mem_reserve_add("camera_ipp_mem_0",ipp_mem_size);
        rk_camera_platform_data.meminfo.size= ipp_mem_size;
        
        rk_camera_platform_data.meminfo_cif1.name = "camera_ipp_mem_1";
        rk_camera_platform_data.meminfo_cif1.start =board_mem_reserve_add("camera_ipp_mem_1",ipp_mem_size);
        rk_camera_platform_data.meminfo_cif1.size= ipp_mem_size;
    #endif
 #endif
 #if 0//PMEM_CAM_NECESSARY
