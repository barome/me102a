...
static struct ricoh619_battery_platform_data ricoh619_power_battery = {
	...
	//4200mv type battery
		...
		.ch_vfchg	= 0x03,	/* VFCHG		= 0x0-0x4 (4.05v 4.10v 4.15v 4.20v 4.35v) */
		.ch_vrchg	= 0x04,	/* VRCHG		= 0x0-0x4 (3.85v 3.90v 3.95v 4.00v 4.10v) */
		.ch_vbatovset	= 0x00,	/* VBATOVSET	= 0 or 1 (0 : 4.38V(up)/3.95V(down) 1: 4.53V(up)/4.10V(down)) */
		.ch_ichg	= 0xFF,	/* ICHG		= 0x0-0x1D (100mA - 3000mA) */
		.ch_icchg	= 0x03,	/* ICCHG		= 0x0-3 (50mA 100mA 150mA 200mA) */
		...
		.jt_en		= 1,	/* JEITA Switch	= 1:enable, 0:disable */
        	.jt_hw_sw	= 0,	/* JEITA is controlled by 1:HW, 0:SW */
	...
	//4350mv type battery
		...
		.ch_vfchg2	= 0x04,	/* VFCHG		= 0x0-0x4 (4.05v 4.10v 4.15v 4.20v 4.35v) */
		.ch_vrchg2	= 0x04,	/* VRCHG		= 0x0-0x4 (3.85v 3.90v 3.95v 4.00v 4.10v) */
		.ch_vbatovset2	= 0x01,	/* VBATOVSET	= 0 or 1 (0 : 4.38V(up)/3.95V(down) 1: 4.53V(up)/4.10V(down)) */
		.ch_ichg2	= 0xFF,	/* ICHG		= 0x0-0x1D (100mA - 3000mA) */
		.ch_icchg2	= 0x03,	/* ICCHG		= 0x0-3 (50mA 100mA 150mA 200mA) */
		.ch_ilim_adp2	= 0xFF,	/* ILIM_ADP		= 0x0-0x1D (100mA - 3000mA) */
		.ch_ilim_usb2	= 0xFF,	/* ILIM_USB		= 0x0-0x1D (100mA - 3000mA) */
		.fg_target_vsys2	= 3300, /* This value is the target one to DSOC=0% */
		.fg_target_ibat2	= 1000, /* This value is the target one to DSOC=0% */
		.jt_en2		= 1,	/* JEITA Enable		= 0 or 1 (1:enable, 0:disable) */
        	.jt_hw_sw2	= 0,	/* JEITA HW or SW 	= 0 or 1 (1:HardWare, 0:SoftWare) */
        	.jt_temp_h2	= 50,	/* degree C */ 
        	.jt_temp_l2	= 12,	/* degree C */
        	.jt_vfchg_h2	= 0x04,	/* VFCHG High  	= 0 - 0x04 (4.05, 4.10, 4.15, 4.20, 4.35V) */
        	.jt_vfchg_l2	= 0x01,	/* VFCHG Low  	= 0 - 0x04 (4.05, 4.10, 4.15, 4.20, 4.35V) */
        	.jt_ichg_h2	= 0x0D,	/* ICHG High   	= 0 - 0x1D (100 - 3000mA) */
        	.jt_ichg_l2	= 0x09,	/* ICHG Low   	= 0 - 0x1D (100 - 3000mA) */
