...
//<ASUS-Aled_Zhang20130717>	if (flag_uboot_display) {
...
//	if (!flag_uboot_display) {
		...
		clk_set_rate_nolock(&aclk_lcdc0_pre, 384 * MHZ);
		clk_set_rate_nolock(&aclk_lcdc1_pre, 384 * MHZ);
		clk_set_rate_nolock(&dclk_lcdc0, 75 * MHZ);
		clk_set_rate_nolock(&dclk_lcdc1, 75 * MHZ);
//	}
//<ASUS-Aled_Zhang20130717>
	//cif
