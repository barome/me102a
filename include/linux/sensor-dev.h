...
#define GSENSOR_IOCTL_APP_SET_OFFSET		_IOW(GSENSOR_IOCTL_MAGIC, 0x11, char[GBUFF_SIZE+1])

#define GSENSOR_NEED_CALIBRATION		1
struct Gsensor_cached_data
{
	int calibrationFlag;
	long offset[3]; 
};
...
#define AKM_DATA_SIZE 9
#define AKM_NUM_SENSORS (3)
#define AKM_DELAY_LENGTH (sizeof(int64_t) * AKM_NUM_SENSORS)
struct ECS_cached_data
{
	char compass_data[AKM_DATA_SIZE];
